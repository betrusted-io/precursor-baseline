...
DEFAULT_DEPS = {
    ...
    'lxsocdoc':     'https://github.com/litex-hub/lxsocdoc',
    'encrypt-bitstream-python': 'https://github.com/betrusted-io/encrypt-bitstream-python.git',
    'gateware':     'https://github.com/betrusted-io/gateware.git',
    'valentyusb':   'https://github.com/betrusted-io/valentyusb.git',
    'pythondata-cpu-vexriscv':  'https://github.com/betrusted-io/pythondata-cpu-vexriscv.git',
    'compiler-rt':  'https://github.com/litex-hub/pythondata-software-compiler_rt.git',
...
def main():
    ...
    parser.add_argument(
        '--no-bin', '--lx-no-bin', help="don't create a bin/ directory", action="store_true"
    )
    parser.add_argument(
